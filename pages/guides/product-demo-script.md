...
Roadmap (v8.6.0 / EPIC #193):

```text
bin/plangate metrics TASK-XXXX  # 未実装、PBI-HI-001 で v8.6.0 リリース予定
```

伝えるポイント:

- 感覚ではなく、eval と（v8.6.0 以降の）metrics で改善する
- C-3 / V-1 / C-4 / hook violation を見られる（metrics は roadmap）
