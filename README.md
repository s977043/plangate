...
v7（`docs/plangate-v7-hybrid.md`）で追加された再利用可能 Skill。WF-01〜WF-05 各 phase で呼び出される。
...
| [docs/plangate-v7-hybrid.md](docs/plangate-v7-hybrid.md) | **v7 ハイブリッドアーキテクチャ**（Governance × Modularity）— Workflow / Skill / Agent 3 層 |
| [docs/workflows/README.md](docs/workflows/README.md) | Workflow 5 phase（WF-01〜WF-05）定義・PlanGate 対応表 |
| [.claude/rules/hybrid-architecture.md](.claude/rules/hybrid-architecture.md) | Rule 1〜5 統合ルール + CLAUDE.md/Skill/Hook 境界 |
