...
/schemas                 — JSON Schema（plan / handoff / status / approval / model-profile / Structured Outputs × 4 等）
...
| [docs/ai/eval-plan.md](docs/ai/eval-plan.md) | model migration eval framework（8 観点、v8.3） |
| [docs/ai/responsibility-boundary.md](docs/ai/responsibility-boundary.md) | CLAUDE.md / Skill / Hook の責務境界（v8.3） |
| [docs/ai/tool-policy.md](docs/ai/tool-policy.md) | phase 別 allowed_tools 定義（v8.3） |
| [docs/ai/hook-enforcement.md](docs/ai/hook-enforcement.md) | Hook で強制すべき項目 EHS-1〜EHS-3（v8.3） |
