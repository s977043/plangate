...
mode: high-risk
milestone: v8.2
state: parent:integration_review  # → user 判断で parent:done
issued_at: 2026-04-30
children_done: 6/6
```
...
- parent-plan: `docs/working/PBI-116/parent-plan.md`
- integration-plan: `docs/working/PBI-116/integration-plan.md`
- 各子 handoff: `docs/working/TASK-{0039..0044}/handoff.md`
- 振り返り: `docs/working/retrospective-2026-04-30.md`

## 9. Parent Integration Gate（👤 user 判断）

統合チェック A〜E 全 PASS / Open Gap 0 件 / Release blocker なし。
**ユーザー判断で `approvals/parent-integration.json` に APPROVED 署名 → `parent:done` 遷移可。**
...
```json
{
  ...
  "_summary": "全 6 子 PBI 完了、parent-AC 8/8 PASS、Gap 0 件、Release blocker なし"
}
```
