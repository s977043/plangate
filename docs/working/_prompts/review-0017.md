...
# Target
Review the following 4 files for TASK-0017:
- docs/working/TASK-0017/pbi-input.md
- docs/working/TASK-0017/plan.md
- docs/working/TASK-0017/todo.md
- docs/working/TASK-0017/test-cases.md
...
# Output
Write the review result to: docs/working/TASK-0017/review-external.md
