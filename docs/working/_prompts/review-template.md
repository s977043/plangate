...
# Target
Review the following 4 files for TASK-{TASK_ID}:
- docs/working/TASK-{TASK_ID}/pbi-input.md
- docs/working/TASK-{TASK_ID}/plan.md
- docs/working/TASK-{TASK_ID}/todo.md
- docs/working/TASK-{TASK_ID}/test-cases.md
...
# Output
Write the review result to: docs/working/TASK-{TASK_ID}/review-external.md

Use this exact structure:

```markdown
# TASK-{TASK_ID} 外部AIレビュー結果

> 実施日: 2026-04-19
> レビュアー: Codex (codex-cli {VERSION})
