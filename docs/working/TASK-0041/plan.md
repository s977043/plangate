...
- 🚩 チェックポイント:
  ...
  - PBI-116-02 model-profiles.yaml（マージされていれば）と cross relation 確認（C-2 EX-06-02 typo 修正）
...
|----|------|----------|-----------|
| L1 | tool_policy 値域が PBI-116-02 と乖離 | medium | interface-preflight.md の値域を正、PBI-116-02 成果物が main にマージ済の場合は照合（完了前提ではなく並行可能、C-2 EX-06-01 対応） |
