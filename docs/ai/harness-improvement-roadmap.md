...
## 11. Phase 5: Dynamic Context Engine
...
4. **Phase 4: Keep Rate** — 成果物が実際に残ったかを見る
5. **Phase 5: Dynamic Context Engine** — context の肥大化を抑え、モデル性能向上に追随する
6. **Phase 6: Reporting & Retrospective** — チーム改善サイクルに接続する
