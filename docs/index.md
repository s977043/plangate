...
| ドキュメント | 内容 |
| --- | --- |
| [公開ドキュメント入口]({{ site.github.repository_url }}/blob/{{ site.github.build_revision }}/pages/index.md) | River-Reviewer 形式に寄せた `pages/` 配下の公開説明ドキュメント |
| [Product Overview]({{ site.github.repository_url }}/blob/{{ site.github.build_revision }}/pages/explanation/product/overview.md) | PlanGate の概要、対象ユーザー、価値、仕組み |
| [PM / PO Elevator Pitch]({{ site.github.repository_url }}/blob/{{ site.github.build_revision }}/pages/explanation/product/pm-po-elevator-pitch.md) | PM / PO に PlanGate を説明するための短いピッチ、タグライン、定期見直し観点 |
