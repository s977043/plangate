...
| [Product Documentation](./product/README.md) | PlanGate をプロダクトとして説明するための Product Brief、Positioning、FAQ、Demo Script など |
| [PM / PO Elevator Pitch](./pm-po-elevator-pitch.md) | PM / PO に PlanGate を説明するための短いピッチ、タグライン、定期見直し観点 |
