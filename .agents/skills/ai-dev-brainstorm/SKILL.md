...
description: "アイデアや曖昧な要件を Codex 用の PBI INPUT PACKAGE に対話的に整理する。Use when: docs/working/STRATEGY-XXXX/pbi-input.md を新規作成したい時、要件をブレストして PBI に落としたい時。"
---
...
4. `docs/working/STRATEGY-XXXX/status.md`（存在する場合）

## Output

- `docs/working/STRATEGY-XXXX/pbi-input.md`
- 必要に応じて `docs/working/STRATEGY-XXXX/status.md`
...
Codex CLI では通常 `./scripts/ai-dev-workflow STRATEGY-XXXX brainstorm` から呼び出す。
