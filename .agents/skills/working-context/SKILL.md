...
4. `docs/working/STRATEGY-XXXX/status.md`
5. `docs/working/STRATEGY-XXXX/plan.md`
6. `docs/working/STRATEGY-XXXX/todo.md`
7. `docs/working/STRATEGY-XXXX/test-cases.md`
